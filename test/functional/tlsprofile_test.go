...
const (
	metricsHTTPSPort     = "https://clusterlifecycle-state-metrics.default.svc:8443/metrics"
	telemetryHTTPSPort   = "https://clusterlifecycle-state-metrics.default.svc:8444/metrics"
